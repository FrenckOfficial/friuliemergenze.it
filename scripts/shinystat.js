...
function cCk(nm, vl, mn) {
  ...
  if (SSstoCk(_sscdom, nm)) {
    if (_sscdom && _sscdom != "") {
      ...
      if (mn) {
        document.cookie =
          nm + "=; expires=Thu, 01-Jan-70 00:00:01 GMT; path=/;";
      }
    }
    if (mn) {
      var d = new Date();
...
function ssxl(xl_) {
  ...
  i_.src =
    "https://s3.shinystat.com/cgi-bin/shinystat.cgi?TLR=1&USER=" +
    us_ +
    "&" +
    xl_ +
    "&RM=" +
...
function stfCk(ck, v) {
  ...
  if (
    _ort.getUTCDay() == _ot.getUTCDay() &&
    _ort.getUTCMonth() == _ot.getUTCMonth() &&
    _ort.getUTCFullYear() == _ot.getUTCFullYear()
  )
    uv_ = 0;
  if (sswk_(_ort) == sswk_(_ot)) uvw = 0;
  _iof_ =
    "" + _t_ + "%G" + _pt_ + "%G" + _f_ + "%G" + _tf_ + "%G" + ud() + "%G";
...
function ssadbk(qs) {
  ...
  img.onerror = function () {
    ...
    iabk_.src =
      "https://s3.shinystat.com/cgi-bin/adbsa.cgi" +
      qs +
      "&RM=" +
      Math.round(Math.random() * 2147483647);
...
function ssImage_() {
  ...
  a.href =
    "https://s3.shinystat.com/cgi-bin/shinystatv.cgi?USER=" + us_ + "&NH=1";
  ...
  var q = function (f, b) {
    ...
    g = function () {
      ...
      var e = b.getExtension("WEBGL_debug_renderer_info"),
        v = e
          ? b.getParameter(e.UNMASKED_VENDOR_WEBGL)
          : b.getParameter(b.VENDOR),
        r = e
          ? b.getParameter(e.UNMASKED_RENDERER_WEBGL)
    ...
    S = function (p) {
      ...
      (hc === 0 || hc === 1 || hc === null) && (dm === void 0 || dm === null)
        ? (s -= p === "desktop" ? 10 : 6)
        : (s += 2);
      w
        ? sw
...
var ssqS_ =
  "https://s3.shinystat.com/cgi-bin/shinystat.cgi?USER=" +
  us_ +
  "&REFER=" +
  r_ +
  "&COLOR=" +
...
if (1) {
  ...
  function ssaif() {
    ...
    var uri =
      "https://codicebusiness.shinystat.com/cgi-bin/getcod.cgi?IFSSA=yes&AFF=0&IDS=53595029&SSA=" +
      ssals_ +
      "&RF=" +
      rf_ +
      "&HR=" +
      ssaE(window.location.href) +
      ssaCss() +
      "&NV=" +
      nvs +
      "&RM=" +
    ...
    if (document.getElementById("ifssa")) {
      ...
      try {
        ...
        ifssa.setAttribute(
          "name",
          "ifssa" + Math.round(Math.random() * 100000),
        );
          ...
          __tcfapi(
            ...
            function (data, success) {
              if (
                ...
                typeof data.vendor !== "undefined" &&
                typeof data.vendor.consents !== "undefined" &&
                "491" in data.vendor.consents &&
                data.vendor.consents[491]
              ) {
                // Do something here
  ...
  if (1) {
    var _consentCallback = function (found) {
      ...
      if (found.length) {
        ...
        dcmp_.src =
          "//s6.shinystat.com/cgi-bin/csa.cgi?USER=dcmp&PAG=53595029" +
          cmp +
          "&RM=" +
          Math.round(Math.random() * 2147483647);
    ...
    (function (cb) {
      ...
      consentProviders.push({
        ...
        test: function () {
          return (
            window.document.querySelectorAll('div[id^="cookiescript"]').length >
            0
          );
        },
      });
