!(function (e) {
  ...
  function (e, t, n) {
    ...
    var g = n(4),
      ...
      j = "https://core.service.elfsight.com",
      E = function (e, t, n) {
        t = t || e.document;
        var i,
          o = this,
        ...
        ((o.initialize = function () {
          ((o.logError = h.withModule(m)),
            o.establishPreconnections(),
            o.collectWidgets(t),
            o.revise(),
            g(function () {
              (o.collectWidgets(t),
          ...
          (o.establishPreconnections = function () {
            o.preconnect(o.getPlatformUrl());
          }),
          (o.preconnect = function (e) {
          ...
          (o.requireWidget = function (e) {
            ("string" != typeof e &&
              o.logError("Widget Public ID required and should be a string", {
                pid: e,
              }),
              ~s.indexOf(e) || s.push(e));
          }),
          (o.getEappsClass = function (e) {
          ...
          (o.getWidgetIdByElement = function (e) {
            return "div" === e.tagName.toLowerCase()
              ? o.getEappsClass(e).replace("elfsight-app-", "")
              : e.getAttribute("data-id");
          }),
          (o.getLazyMode = function (e) {
            var t = e.getAttribute("data-elfsight-app-lazy");
            return "" === t ? y : null !== t && k.includes(t) ? t : w;
          }),
          (o.getWidgetsElements = function (e) {
            if (
              ((e = e || t),
              !e ||
          ...
          (o.collectWidgets = function (e) {
            o.getWidgetsElements(e).forEach(function (e) {
              if (!c.includes(e)) {
                var t = o.getWidgetIdByElement(e);
                if (t) {
                  var n = o.getLazyMode(e);
                  (n === w
                    ? o.requireWidget(t)
                    : o.bootWidgetDeferredly(e, t, n),
                    c.push(e));
                }
              }
            });
          }),
          (o.bootWidgetDeferredly = function (e, t, n) {
            function i() {
              l.splice(0, l.length).forEach(function (e) {
                e();
              });
            }
            function r() {
              (i(), o.requireWidget(t), o.revise());
            }
            function a() {
            ...
            var l = [],
              c = [y, C].includes(n);
            c && l.push(s());
            var p = [y, x].includes(n);
            p && l.push(a());
          }),
          (o.watchWidgetReset = function () {
            window.addEventListener("message", function (e) {
              var t = e.data;
              t.action &&
                "EappsPlatform.widgetReset" === t.action &&
                o.resetWidget(t.widgetId);
            });
          }),
          (o.resetWidget = function (e) {
            var t = function e(t) {
              var e = document.createElement("div");
              return ((e.className = "elfsight-app-" + t), e);
            };
            o.getWidgetsElements().forEach(function (n) {
              o.getWidgetIdByElement(n) === e &&
                (delete a[e], n.parentNode.replaceChild(t(e), n));
            });
          }),
          (o.initWidget = function (e) {
            var t = o.getWidgetIdByElement(e),
              i = a[t];
            if (i) {
              if (!i.status || !i.data)
          ...
          (o.boot = function (e, t) {
            ...
            if (
              (n.forEach(function (e) {
                d.includes(e) || (d.push(e), i.push(e));
              }),
              i.length)
            ) {
              var p = new XMLHttpRequest(),
                f = o.getPlatformUrl();
              f += "/p/boot/";
              var u = b.stringify({ w: i.join(","), page: o.getPage() });
              (p.open("get", f + "?" + u),
                (p.withCredentials = !0),
                (p.onload = function () {
                  var t = JSON.parse(p.response);
                  t.status ||
                    o.logError("Boot failed because " + t.reason, t.data);
                  var n = Object.fromEntries(
                    Object.entries(t.data.widgets).map(function (e) {
                      var t = l(e, 2),
                        n = t[0],
                        i = t[1];
                      return [
                        ...
                        r({}, i, {
                          data: i.data
                            ? r({}, i.data, {
                                settings:
                                  "string" == typeof i.data.settings
                                    ? JSON.parse(i.data.settings)
                                    : i.data.settings,
                              })
                            : void 0,
                        }),
                  ...
                  ((a = Object.assign({}, a, n)),
                    o.loadAssets(t.data.assets),
                    c.forEach(o.initWidget.bind(o)),
          ...
          (o.getPage = function () {
            try {
              ...
              if (L.test(e)) return new URL(e).toString();
            } catch (e) {}
          }),
          (o.getPlatformUrl = function () {
            return e.eappsCustomPlatformUrl ? e.eappsCustomPlatformUrl : j;
          }),
          (o.revise = function () {
            var e = s.filter(function (e) {
              return !(e in a);
            });
            e.length > 0 ? o.boot(null, e) : c.forEach(o.initWidget.bind(o));
          }),
          (o.loadAssets = function (t) {
            t &&
              t.length &&
              t
                .filter(function (e) {
